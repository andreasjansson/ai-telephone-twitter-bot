...
_Two robots playing a game of telephone. One that generates images from captions (using https://replicate.com/stability-ai/stable-diffusion, and one that generates captions from images (using https://replicate.com/methexis-inc/img2prompt)._
